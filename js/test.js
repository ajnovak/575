(function(){
    ...
    var attrArray = ["airdomainindex", "builtdomain", "landdomain", "envqual", "sociodemo", "waterdomain"]; //list of attributes
...
function setEnumerationUnits(counties,map,path,colorScale){	
    ...
    var regions = map.selectAll(".regions")        
        ...
        var desc = regions.append("desc").text('{"stroke": "#CCC", "stroke-width": "0.75px"}');
    };
